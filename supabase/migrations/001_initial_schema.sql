-- Flowpin Initial Schema
-- UP: Creates all enums, tables, RLS policies, and triggers for the Flowpin MVP.
...
CREATE TYPE task_source AS ENUM ('manual', 'linear', 'attio');
CREATE TYPE task_status AS ENUM ('active', 'completed', 'archived');
CREATE TYPE integration_type AS ENUM ('linear', 'attio');
